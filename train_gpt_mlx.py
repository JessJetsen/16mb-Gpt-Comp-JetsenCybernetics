...
class Hyperparameters:
    ...
    lr_warmup_steps: int = int(os.environ.get("LR_WARMUP_STEPS", 0))
    ...
    def lr_mul(self, step: int, elapsed_ms: float) -> float:
        warmup_mul = min((step + 1) / max(self.lr_warmup_steps, 1), 1.0) if self.lr_warmup_steps > 0 else 1.0
...
def main() -> None:
    ...
    log(
        ...
        f"warmup_steps:{args.warmup_steps} lr_warmup_steps:{args.lr_warmup_steps} "
